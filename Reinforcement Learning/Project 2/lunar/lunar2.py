...
if __name__ == '__main__':
    ...
    gammas = [0, 0.5, 0.99]
    mem_sizes = [10000, 1000000, 1000000]
        ...
        for mem_size in mem_sizes:
            for epsilon_dec in epsilon_decs:
                ...
                agent = Agent(gamma=gamma, epsilon=1.0, lr=lr, input_dims=env.observation_space.shape, n_actions=env.action_space.n, 
                              mem_size=mem_size, epsilon_dec=epsilon_dec, batch_size=64, epsilon_end=0.01, fname='models/model_{}_{}_{}.h5'.format(gamma,mem_size,str(epsilon_dec)[-1]))
                scores = []
                avg_scores = []
                eps_history = []
                iter_time = []
